        ...
        <div class="py-5 d-flex flex-column justify-content-center align-items-center">
            ...
            <div id="form" class="col-12 col-lg-8">
                <div class="d-flex flex-column gap-4">
                    ...
                    <textarea placeholder="Place your message here ..." name="message" rows="10" class="form-control input"></textarea>
                </div>
                <button class="btn mt-3 btn-dark" id="btn-submit"> Submit <i class="fa-solid fa-paper-plane ms-2"></i></button>
